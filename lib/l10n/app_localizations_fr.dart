...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String rowCountTitle(int rows) {
    return 'Pourquoi y a-t-il $rows lignes ?';
  }

  @override
  String rowCountExplanation(int vars) {
    return 'Chaque proposition a 2 valeurs possibles (V ou F). Avec $vars propositions, il y a 2 puissance $vars combinaisons : une pour chaque ligne.';
  }
  ...
  @override
  String get instagramFollow => 'Suivre le développeur';
  ...
  @override
  String get karnaughTitle => 'Tableau de Karnaugh';

  @override
  String get karnaughDescription =>
      'Regroupez les cellules adjacentes en puissances de 2 pour obtenir l\'expression booléenne minimale de la fonction.';

  @override
  String get karnaughUnsupportedVars => 'Disponible pour 2 à 4 variables';

  @override
  String get karnaughUnsupportedVarsDesc =>
      'Le tableau de Karnaugh est affiché pour les expressions de 2, 3 ou 4 variables (sans constantes).';

  @override
  String get karnaughAdGate =>
      'Regardez une courte vidéo pour débloquer le tableau de Karnaugh de cette expression.';

  @override
  String get karnaughSopDescription =>
      'SOP : regroupe les 1 (somme de produits)';

  @override
  String get karnaughPosDescription =>
      'POS : regroupe les 0 (produit de sommes)';

  @override
  String get karnaughMinimizedExpression => 'Expression minimisée';

  @override
  String get karnaughGroupsTitle => 'Groupes';

  @override
  String karnaughGroupCells(int count) {
    return '$count cellules';
  }

  @override
  String get karnaughConstant =>
      'La fonction est constante : aucun groupe à former.';

  @override
  String get simplificationTab => 'Simplifier';

  @override
  String get simplificationTitle => 'Simplification étape par étape';

  @override
  String get simplificationDescription =>
      'Applique les lois de l\'algèbre propositionnelle pour réduire l\'expression à une forme plus simple. La commutativité et l\'associativité sont appliquées implicitement.';

  @override
  String get simplificationAdGate =>
      'Regardez une courte vidéo pour débloquer la simplification étape par étape de cette expression.';

  @override
  String get simplificationOriginal => 'Expression originale';

  @override
  String get simplificationResult => 'Résultat';
  ...
  @override
  String get lawConditional => 'Loi du conditionnel';

  @override
  String get lawBiconditional => 'Loi du biconditionnel';

  @override
  String get lawConverse => 'Implication réciproque';

  @override
  String get lawXorDefinition => 'Définition du XOR';

  @override
  String get lawNandDefinition => 'Définition du NAND';

  @override
  String get lawNorDefinition => 'Définition du NOR';

  @override
  String get lawNegatedConditional => 'Négation du conditionnel';

  @override
  String get lawNegatedConverse => 'Négation de la réciproque';

  @override
  String get lawNegatedBiconditional => 'Négation du biconditionnel';

  @override
  String get lawTautologyOperator => 'Opérateur tautologie';

  @override
  String get lawContradictionOperator => 'Opérateur contradiction';

  @override
  String get lawDoubleNegation => 'Double négation';

  @override
  String get lawDeMorgan => 'Loi de De Morgan';

  @override
  String get lawNegationOfConstant => 'Négation d\'une constante';

  @override
  String get lawIdempotence => 'Idempotence';

  @override
  String get lawIdentity => 'Identité';

  @override
  String get lawDomination => 'Domination';

  @override
  String get lawComplement => 'Complément';

  @override
  String get lawAbsorption => 'Absorption';

  @override
  String get lawFactorization => 'Distributivité (factorisation)';

  @override
  String get instagramPromoTitle => 'Suivez-moi sur Instagram !';

  @override
  String get instagramPromoButton => 'Suivre sur Instagram';

  @override
  String get instagramPromoLater => 'Peut-être plus tard';

  @override
  String get a11yBackspace => 'Supprimer';

  @override
  String get a11yToggleCase => 'Majuscules/minuscules';

  @override
  String get a11yEvaluate => 'Calculer';

  @override
  String a11yKarnaughMap(int count) {
    return 'Carte de Karnaugh avec $count groupes';
  }

  @override
  String a11yKarnaughGroup(int number, String term, int count) {
    return 'Groupe $number : $term, $count cellules';
  }
  ...
  @override
  String get proKarnaughBenefit => 'Tableaux de Karnaugh sans publicité';

  @override
  String get proSimplificationBenefit => 'Simplification pas à pas instantanée';

  @override
  String get proNormalFormsBenefit =>
      'Formes normales (FND/FNC) instantanément';
}
